...
public class Chapter02 {
    ...
    public void run() throws InterruptedException{
        ...
        testLoginCookeis(conn);
        testShoppingCartCookies(conn);
        testCacheRows(conn);
        testCacheRequest(conn);
    }

    public void testLoginCookeis(Jedis conn) throws InterruptedException{
        System.out.println("\n-------------testLoginCookies-----------");
        ...
        System.out.println("Let't drop the maximum number of cookies to 0 to clean them out");
        System.out.println("We will start a thread to do the cleaning, while wo stop it later");
    ...
    public void testCacheRows(Jedis conn) throws InterruptedException {
        System.out.println("\n----------testCacheRows---------");
        System.out.println("First, let's schedule caching of itemC every 5 seconds");
    ...
    public void testCacheRequest(Jedis conn) {
        ...
        System.out.println("We are going to cche a simple request against " + url);
        ...
        assert !canCache(conn, "http://test.ocom/");
        assert !canCache(conn, "http://test.com/?item=itemX&_=12345336");
    }
